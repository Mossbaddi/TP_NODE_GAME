...
// console.log(document.querySelector("#gamecontainer").attributes.Username.value);

let personnages = {
	Guerrier: new Guerrier(document.querySelector("#gamecontainer").attributes.Username.value, 1, document.querySelector("#gamecontainer").attributes.UserBG.value),
	Mage: new Mage(document.querySelector("#gamecontainer").attributes.Username.value, 1, document.querySelector("#gamecontainer").attributes.UserBG.value),
	Tank: new Tank(document.querySelector("#gamecontainer").attributes.Username.value, 1, document.querySelector("#gamecontainer").attributes.UserBG.value),
...
document.querySelector("#lancement").addEventListener("click", () => {
	startgame(document.querySelector("#gamecontainer").attributes.gameclasse.value);
	document.getElementById("lancement").remove();
	changedisplaywithid("containerbtn", "none");
